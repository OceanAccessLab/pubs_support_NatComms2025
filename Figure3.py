...
import pandas as pd
import xarray as xr
#import datetime (may need to import 'PROJ_LIB')
...
for years in years_list:
    ...
    if (len(df_tmp2)>0) & (years[0]>1975):
        ...
        if trend>0:
            plt.annotate('+' + "{:.0f}".format(np.abs(trend)) + r'$\rm \,kt\,yr^{-1}$', xy=(.985, 0.015), xycoords='axes fraction', color=WARM_COLOR, fontsize=20, fontweight='bold', horizontalalignment='right', verticalalignment='bottom', backgroundcolor="w", zorder=100)
        elif trend<0:
            plt.annotate('-' + "{:.0f}".format(np.abs(trend)) + r'$\rm \,kt\,yr^{-1}$', xy=(.985, 0.015), xycoords='axes fraction', color=COLD_COLOR, fontsize=20, fontweight='bold', horizontalalignment='right', verticalalignment='bottom', backgroundcolor="w", zorder=100)
   ...
   ## Trends biomass density (Mariano)
    ...
    if len(df_tmp4)>2:
        ...
        trend = summary['mean_slope'].round(2)
        if trend>0:
            plt.annotate('+' + "{:.1f}".format(np.abs(trend)) + r'$\rm \,t\,km^{-2}\,yr^{-1}$', xy=(.985, .10), xycoords='axes fraction', color=WARM_COLOR, fontsize=20, fontweight='bold', horizontalalignment='right', verticalalignment='bottom', backgroundcolor="w", zorder=100)
        elif trend<0:
            plt.annotate('-' + "{:.1f}".format(np.abs(trend)) + r'$\rm \,t\,km^{-2}\,yr^{-1}$', xy=(.985,.10), xycoords='axes fraction', color=COLD_COLOR, fontsize=20, fontweight='bold', horizontalalignment='right', verticalalignment='bottom', backgroundcolor="w", zorder=100)
    ...
    if len(df_tmp)>0:
        ...
        if (years[0]==1999) | (years[0]==2007):
            ...
            plt.annotate('+' + "{:.0f}".format(np.abs(trend)) + r'$\rm \,kt\,yr^{-1}$', xy=(.985, .19), xycoords='axes fraction', color=WARM_COLOR, fontsize=20, fontweight='bold', horizontalalignment='right', verticalalignment='bottom', backgroundcolor="w", zorder=100)
        elif trend<0:
            plt.annotate('-' + "{:.0f}".format(np.abs(trend)) + r'$\rm \,kt\,yr^{-1}$', xy=(.985, .19), xycoords='axes fraction', color=COLD_COLOR, fontsize=20, fontweight='bold', horizontalalignment='right', verticalalignment='bottom', backgroundcolor="w", zorder=100)
    ...
    if len(df_tmp6)>0:
        ...
        if anom>0:
            plt.annotate('+' + "{:.2f}".format(np.abs(anom[0])) + r'$\rm \,mgC\,m^{-3}\,d^{-1}$', xy=(.98,.84), xycoords='axes fraction', color=WARM_COLOR, fontsize=20, fontweight='bold', horizontalalignment='right', verticalalignment='bottom', backgroundcolor="w", zorder=100)
        elif anom<0:
            plt.annotate('-' + "{:.2f}".format(np.abs(anom[0])) + r'$\rm \,mgC\,m^{-3}\,d^{-1}$', xy=(.98,.84), xycoords='axes fraction', color=COLD_COLOR, fontsize=20, fontweight='bold', horizontalalignment='right', verticalalignment='bottom', backgroundcolor="w", zorder=100)
    ...
    if len(df_tmp7)>0:
        ...
        if (years[0]==1999):
            ...
            plt.annotate('+' + "{:.1f}".format(np.abs(anom)) + r'$\rm\,log_{10}(ind\,m^{-2})$', xy=(.98,.76), xycoords='axes fraction', color=WARM_COLOR, fontsize=20, fontweight='bold', horizontalalignment='right', verticalalignment='bottom', backgroundcolor="w", zorder=100)
        elif anom<0:
            plt.annotate('-' + "{:.1f}".format(np.abs(anom)) + r'$\rm\,log_{10}(ind\,m^{-2})$', xy=(.98,.76), xycoords='axes fraction', color=COLD_COLOR, fontsize=20, fontweight='bold', horizontalalignment='right', verticalalignment='bottom', backgroundcolor="w", zorder=100)
